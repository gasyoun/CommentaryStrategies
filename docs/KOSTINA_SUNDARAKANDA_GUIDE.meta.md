...
неё — отдельное руководство под её роль. Фактура — из
[issue №57](https://github.com/gasyoun/CommentaryStrategies/issues/57),
...
3. **Актуализация задачи 2 после её решения** — когда Костина выберет
   «А»/«Б» по пометам, переписать раздел из вопроса в констатацию.
   Статус: заблокировано её ответом.
...
- Числа даны округлённо на дату создания.
...
|---|---|---|
| 10-07-2026 | Первая версия: 9 разделов, её четыре задачи, словарик | Fable 5 (`claude-fable-5`), H517 |
