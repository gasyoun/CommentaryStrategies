...
- [x] Большие `.docx/.pdf` — в релизы. **Замер 26-08-2026:** отслеживаемых бинарников ≈ 21,8 МБ, из них
  ...
  → дорожка C, не A. **Repo-side половина готова (29-08-2026, drain A05, [PR #210](https://github.com/gasyoun/CommentaryStrategies/pull/210)):**
  правовая раскладка всех 8 отслеживаемых бинарников — механически выкладываемых сегодня ноль
  ([docs/BINARY_RELEASES.md](https://github.com/gasyoun/CommentaryStrategies/blob/main/docs/BINARY_RELEASES.md)),
  guarded uploader `scripts/release_binaries.py` (dry-run по умолчанию, allowlist владельца обязателен,
  класс rights не проходит без `--rights-cleared`) и анти-рост гейт переписи бинарников в CI
  (новый неотслеженный классом бинарник краснит «Corpus integrity»). **Остаток — Дорожка C, за М.Г.:**
  решения по файлам (разрешение на оба скана, момент публикации рукописей) и прогон выкладки
  ≈10 мин/файл по прогону.
