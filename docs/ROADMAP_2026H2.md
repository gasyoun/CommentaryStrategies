...
- [x] Исправлено расхождение ARCHITECTURE.md: ось 4 «P/C/K» → «P/K/D» (понятие/кодификатор/концепт-расхождение); ось 1 синхронизирована с 9-значной схемой
...
- [ ] Вынести сохранённые веб-страницы (`महाभारत_files/`, `Рамаяна…_files/`) из git; большие .docx/.pdf — в релизы
