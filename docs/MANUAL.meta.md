...
Заведён 10-07-2026 — позже субъекта (создан 07-07-2026): в сессии тройки
...
1. **§5/§8 живут — обновлять по факту**: после каждого проголосованного
   листа вычёркивать его из §5-таблицы и §8-блокеров; §8 датирован
   07-07-2026 и начнёт врать первым. Статус: стоячее правило.
2. **Счётчики нот** (партия-3 227, лексический 604+7 и т.д.) после apply
...
- Числа и статусы в §3/§5/§8 — снимок на 07-07-2026; живое состояние — в
  ...
  и трёх персональных issues ([№56](https://github.com/gasyoun/CommentaryStrategies/issues/56) ·
...
- MANUAL сознательно не дублирует метод-детали —
  ...
  остаётся каноном рубрики судьи и контракта черновиков.
