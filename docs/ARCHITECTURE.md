...
обработки); рукописные страницы — развернутая аналитика поверх всего материала.
...
## 3. Модель данных: четырехосная сетка
...
```json
{
  ...
  "translator": "grintser",
  "raw_text": "«…Темнокожий (snigdha-varṇaḥ)…» Букв.: «цвета масла»…",
  "has_iast": true,
...
- **Ось 2 (Казанский) — РАЗРЕШЕНО (2026-06-14):** эмпирическая ре-инженерия 300
  ...
  **V = историко-культурный/реалийный** (касты, реки, божества — широкий in-world
  бакет), не «B реалийный / V исторический». `prompts/classify_note.md` приведен в
  соответствие; ошибка B=реалийный держала классификатор на 10 % axis_2 (→ 79 %).
- **Межкодерская надежность (B5):** нужен второй кодировщик + Cohen's κ — **именно
