...
[`apparatus_mbh-adiparva_variants.json`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/adiparva/apparatus_mbh-adiparva_variants.json) /
[`APPARATUS_MBH-ADIPARVA_VARIANTS.md`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/adiparva/APPARATUS_MBH-ADIPARVA_VARIANTS.md) —
**5238 чистых вариантных пары** (из 5995 difflib-«variant», 732 слишком
переформулированы → в слой отсутствий, 0 кириллических загрязнений) → **31310 позиционных
