...
[`apparatus_mbh-swargarohanaparva_variants.json`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/swargarohanaparva/apparatus_mbh-swargarohanaparva_variants.json) /
[`APPARATUS_MBH-SWARGAROHANAPARVA_VARIANTS.md`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/swargarohanaparva/APPARATUS_MBH-SWARGAROHANAPARVA_VARIANTS.md) —
**156 чистых вариантных пары** (из 173 difflib-«variant», 16 слишком
переформулированы → в слой отсутствий, 0 кириллических загрязнений) → **783 позиционных
