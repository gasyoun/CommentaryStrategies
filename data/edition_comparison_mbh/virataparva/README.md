# BORI/Poona критическое издание ↔ Нīлакантха-вульгата — virataparva (кн. 4)
...
|---|---:|---:|---:|
| **Адхьяй** | **67** | **72** | **+5** |
| **Шлок** | **1824** | **2270** (= перепись census) | **+446** |

- Вульгата содержит **5 целых адхьяй без критического аналога** (6, 34, 40, 41, 42) — не сверено построфно.
- Выравнивание: идентичных **48** · вариантных **1652** (вкл. 3 fuzzy-пар) ·
  «только в критическом» **124** · транспозиций 0/0.
- Вульгатные шлоки без выравнивания = 570: **464 — истинное отсутствие**,
  **106 — переформулировка**.
- Крупнейшие вульгата-only пассажи (184 runs): 4.55.3–39 (37) · 4.6.1–35 (35) · 4.14.12–31 (20) · 4.22.50–64 (15) · 4.61.3–17 (15) · 4.57.1–14 (14).
...
**1462 чистых вариантных пары** (из 1652 difflib-«variant», 183 слишком
переформулированы → в слой отсутствий, 0 кириллических загрязнений) → **7656 позиционных
loci** по всем 67 адхьяям.
...
плюс апарат `apparatus_mbh-virataparva_variants.json`/`.md` (committed — короткие loci).
