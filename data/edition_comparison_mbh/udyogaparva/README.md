...
[`apparatus_mbh-udyogaparva_variants.json`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/udyogaparva/apparatus_mbh-udyogaparva_variants.json) /
[`APPARATUS_MBH-UDYOGAPARVA_VARIANTS.md`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/udyogaparva/APPARATUS_MBH-UDYOGAPARVA_VARIANTS.md) —
**4243 чистых вариантных пары** (из 4907 difflib-«variant», 641 слишком
переформулированы → в слой отсутствий, 0 кириллических загрязнений) → **22901 позиционных
loci** по всем 189 адхьяям.
