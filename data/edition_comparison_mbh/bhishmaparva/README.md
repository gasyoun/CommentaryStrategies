...
[`apparatus_mbh-bhishmaparva_variants.json`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/bhishmaparva/apparatus_mbh-bhishmaparva_variants.json) /
[`APPARATUS_MBH-BHISHMAPARVA_VARIANTS.md`](https://github.com/gasyoun/CommentaryStrategies/blob/main/data/edition_comparison_mbh/bhishmaparva/APPARATUS_MBH-BHISHMAPARVA_VARIANTS.md) —
**3828 чистых вариантных пары** (из 4302 difflib-«variant», 460 слишком
переформулированы → в слой отсутствий, 0 кириллических загрязнений) → **19885 позиционных
