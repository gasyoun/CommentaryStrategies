...
## 2026-06-29 — Sundarakāṇḍa apparatus: all four Kazansky levels
...
- **Lexical layer (А)** — 611 etymological/lexical gloss notes across all 68 chapters
  ...
  apparatus from ~5 % to **Grintser-level ~24 % density**. (PR #33; documented in
  [SUNDARA_COMMENTARY_RATIONALE.md](SUNDARA_COMMENTARY_RATIONALE.md), Режим 3.)
- **Г историко-культурологический layer** — 11 background intro-articles
  ...
  4th Kazansky level. Mostly Grintser cross-references (≈1 % yield = Leonov's own profile);
  `trikūṭa` the one new-in-Book-V article. (PR #38.)
