...
OUT = os.path.join(DIR, "commentarystrategies-edition-footnotes_v1_review.html")
...
function dl(){const b=new Blob([payload()],{type:"application/json"});const u=URL.createObjectURL(b);const a=document.createElement("a");a.href=u;a.download="commentarystrategies-edition-footnotes_v1_decisions.json";a.click();URL.revokeObjectURL(u);}
