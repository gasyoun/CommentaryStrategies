...
# Метаданные переводчиков: полное имя, цвет, светлый фон, текст/корпус
TRANSLATORS = {
    "kalyanov":  ("В. И. Кальянов", "#1f6feb", "#eaf2ff", "Махабхарата (полный академический перевод)"),
    "vassilkov": ("Я. В. Васильков, С. Л. Невелева", "#2da44e", "#e9f7ee", "Махабхарата (книги Вана, Карна и др.)"),
    "erman":     ("В. Г. Эрман", "#bf3989", "#fbeaf3", "Махабхарата, Бхишмапарва (с Бхагавадгитой)"),
    "grintser":  ("П. А. Гринцер", "#d97706", "#fdf1e0", "Рамаяна (книги 1–4)"),
    "syrkin":    ("А. Я. Сыркин", "#8250df", "#f1ecfb", "Упанишады"),
    "leonov":    ("М. А. Леонов, ред. Е. Костина", "#cf222e", "#fdeced", "Рамаяна, книга 5 (Сундараканда) — продолжающийся перевод"),
}
...
def build(name, template):
    ...
    full, color, light, desc = TRANSLATORS[name]
    repl = {
