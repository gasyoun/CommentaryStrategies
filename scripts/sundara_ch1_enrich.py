...
# Attribution: М.В. Леонов, «Рамаяна. Книга 5. Сундараканда» (продолжающийся перевод; лит. ред. Е. Костина).
PROVENANCE = {
    "translator": "М.В. Леонов",
    "source": "Рамаяна. Книга 5. Сундараканда (продолжающийся перевод; лит. ред. Е. Костина)",
