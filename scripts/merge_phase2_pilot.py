...
REJECT_BUCKETS = [
    ...
    ("duplicate_of_tier1", ["дублирует собственное примечание", "дублирует примечание леонова",
                            "уже отмечено костиной", "уже приведен", "уже приведён", "тир-1", "tier-1"]),
    ("overlaps_other_note", ["overlap", "duplicate", "повтор", "вынесен", "вариац", "разобран в примеч",
                             "относительно примеч", "дублирует примечание фазы-1", "уже разобран"]),
